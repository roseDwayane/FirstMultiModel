...
class GitModel(GitPreTrainedModel):
    ...
    def forward(
        ...
        if pixel_values is not None:
            ...
            #print("(GitModel) visual_features: ", visual_features.shape)
            projected_visual_features = self.visual_projection(visual_features)
            #print("(GitModel) projected_visual_features: ", projected_visual_features.shape)
...
class GitForCausalLM(GitPreTrainedModel, GenerationMixin):
 ...
 #   @replace_return_docstrings(output_type=CausalLMOutputWithPast, config_class=_CONFIG_FOR_DOC)
    def forward(
        ...
        #print("hiiiiiiiiiiiiiiii logits shape:", logits.shape)
        ...
        if labels is not None:
            ...
            #shifted_logits = logits[:, 394:-1, :].contiguous()
            labels = labels[:, 1:].contiguous()
            #print("hiiiiiiiiiiiiiiii2 Shifted logits shape:", shifted_logits.shape)
            #print("Labels shape:", labels.shape)
